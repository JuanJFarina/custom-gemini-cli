...
REQUIRED_COLUMNS = frozenset(
    {
        ...
        "event_notification_deliveries.delivered_at",
        "event_notification_deliveries.event_id",
        "event_notification_deliveries.id",
        "event_notification_deliveries.notification_window_start",
        "event_notification_deliveries.occurrence_starts_at",
        "event_notification_deliveries.user_id",
        "event_notification_quota_notices.attempted_at",
        "event_notification_quota_notices.delivered_at",
        "event_notification_quota_notices.period_starts_at",
        "event_notification_quota_notices.status",
        "event_notification_quota_notices.user_id",
        ...
        "internal_events.event_type",
        "internal_events.id",
        "internal_events.last_notified_at",
        "internal_events.notification_window_start",
        "internal_events.recurrence_rule",
        ...
        "interaction_events.last_agent_message_at",
        "interaction_events.last_user_message_at",
        ...
        "telegram_update_claims.conversation_id",
        "telegram_update_claims.delivered_at",
        "telegram_update_claims.message_text",
        "telegram_update_claims.status",
        "telegram_update_claims.telegram_chat_id",
        "telegram_update_claims.telegram_user_id",
        "telegram_update_claims.tool_started_at",
        "telegram_update_claims.update_id",
        "telegram_update_claims.updated_at",
        ...
        "web_sessions.id",
        "web_sessions.last_used_at",
        "web_sessions.revoked_at",
        "web_sessions.session_token_hash",
